...
exports.applicationNotificationTemplate = ({
  to,
  from,
  subject,
  firstName,
              ...
              <tr>
                <td align="center" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableCard"
                    ...
                    <tbody>
                      <tr>
                        <td style="background-color:#F7B919;font-size:1px;line-height:3px" class="topBorder" height="3">
                          &nbsp;</td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 20px; padding-top: 40px;" align="center" valign="top"
                          class="imgHero">
                          <a href="#" style="text-decoration:none" target="_blank">
                            <img alt="" border="0"
                              ...
                              style="width:100%;max-width:100px;height:auto;display:block;color: #f9f9f9;" width="100">
                          </a>
                        </td>
                      </tr>
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        <td style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px"
                          ...
                          <a href="https://www.facebook.com/loopnotluck/" style="display:inline-block" target="_blank"
                            class="facebook">
                            <img alt="" border="0"
                          ...
                          <a href="https://twitter.com/loopnotluck" style="display: inline-block;" target="_blank"
                            class="twitter">
                            <img alt="" border="0"
                          ...
                          <a href="https://www.tiktok.com/@loopnotluck" style="display: inline-block;" target="_blank"
                            class="pintrest">
                            <img alt="" border="0"
                          ...
                          <a href="https://www.instagram.com/loopnotluck/" style="display: inline-block;"
                          ...
                          <a href="https://www.linkedin.com/company/loopnotluck/" style="display: inline-block;"
                      ...
                      <tr>
                        <td style="padding: 10px 10px 5px;" align="center" valign="top" class="brandInfo">
                          <p class="text"
                            style="color:#000000;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;padding:0;margin:0">
                            ©&nbsp;Loop Not Luck Limited. | 64 KNIGHTSBRIDGE, LONDON SW1X 7JF.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0px 10px 20px;" align="center" valign="top" class="footerLinks">
                          <p class="text"
                            style="color:#000000;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;padding:0;margin:0">
                            <a href="https://loopnotluck.com/" style="color:#000000;text-decoration:underline"
                              target="_blank">https://loopnotluck.com/</a>
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0px 10px 10px;" align="center" valign="top" class="footerEmailInfo">
                          <p class="text"
                            style="color:#000000;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:12px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;padding:0;margin:0">
                            If you have any quetions please contact us <a href="mailto:hello@loopnotluck.com"
                              style="color:#000000;text-decoration:underline" target="_blank">hello@loopnotluck.com.</a>
                        </td>
                      </tr>
                      <tr>
                        <td style="font-size:1px;line-height:1px" height="30">&nbsp;</td>
